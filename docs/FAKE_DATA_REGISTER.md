...
|---|---|---|---|---|---|---|
| `backend/main.py` | Full file | `random.uniform`, synthetic candles, mock ticks | Monolithic duplicate backend with simulated market data | High: Misleads clients with synthetic prices | Deprecate and isolate backend/ under legacy/; use cryptoscope-ai exclusively | **DEPRECATED & ISOLATED IN legacy/backend/** |
