"""
CryptoScope AI FastAPI Backend Application.
Provides asynchronous real-time market data, probabilistic machine learning inference,
order book metrics, derivatives analytics, risk gating, and JWT authentication.
"""
